        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FundingRequested = table.Column<decimal>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Documents_Applications_GrantApplicationId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    GrantApplicationId = table.Column<int>(type: "INTEGER", nullable: false),
                    TotalFundsAllocated = table.Column<decimal>(type: "TEXT", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Grants_Applications_GrantApplicationId",
                        column: x => x.GrantApplicationId,
                        principalTable: "Applications",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reviews_Applications_GrantApplicationId",
                        column: x => x.GrantApplicationId,
                        principalTable: "Applications",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Milestones_Grants_GrantId",
                        column: x => x.GrantId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Grants_GrantApplicationId",
                table: "Grants",
                column: "GrantApplicationId");

            migrationBuilder.CreateIndex(
                name: "IX_Milestones_GrantId",
                table: "Milestones",
                column: "GrantId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reviews_GrantApplicationId",
                table: "Reviews",
                column: "GrantApplicationId");
